...
render(){
    return(
        ...
        <div>
         ...
         <div style={{marginLeft:"50px"}}>
         <input type="text" onChange={(e)=>this.setState({companyName:e.target.value,compName:"Company Name"})} className="textfield" placeholder="Company Name"/><br/><br/>   
         </div>
         ...
         <div style={{marginLeft:"50px"}}>
         <input type="text" onChange={(e)=>this.setState({campaignName:e.target.value,staticCampaigNname: "Campaign Name"})} className="textfield" placeholder="Campaign Name"/><br/><br/>   
         </div>
